# pylint: disable-msg=R0201, R0904, R0902, C0302
# R0201: Resolving this issues would change the interface. 
# R0904/R0902: Too many attributes and methods.
# C0302: Too many module lines.
# In near future one should refactor out property, ACL, data handling and provide a simple descriptor.
#
# Created: Malte Legenhausen (mail to malte.legenhausen@dlr.de)
#
# Version: $Id: base.py 4620 2010-04-19 15:58:15Z schlauch $
#
...
__version__ = "$LastChangedRevision: 4620 $"
    ...
    def privileges(self):
        ...
        if self._privileges is None:
            ...
            if not self.fileStorer is None:
                for privilege in self.fileStorer.retrievePrivileges():
