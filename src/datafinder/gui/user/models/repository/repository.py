...
# W0201: The attribute is defined in the base class. But
#        on commit time pylint cannot see this.
# C0302: Too many module lines.
#
# Created: 16.02.2009 mohr_se <steven.mohr@dlr.de>
# Changed: $Id: repository.py 4623 2010-04-20 07:12:17Z schlauch $ 
# 
# 
...
__version__ = "$LastChangedRevision: 4623 $"
