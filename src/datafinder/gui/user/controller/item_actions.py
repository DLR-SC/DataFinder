...
# W0142: To provide one interface to use the progress dialog for different actions.
#
# Created: 01.06.2009 schlauch <Tobias.Schlauch@dlr.de>
# Changed: $Id: item_actions.py 4625 2010-04-20 11:33:04Z schlauch $ 
# 
...
__version__ = "$LastChangedRevision: 4625 $"
